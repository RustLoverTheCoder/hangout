    ...
    <div className="w-full pl-2 flex flex-col gap-y-px">
      ...
      >
        <div className="rounded flex h-10.5 px-2 hover:bg-modifier-selected flex items-center justify-start overflow-hidden">
          ...
          <div className="ml-3 flex-1 text-white text-base font-semibold">
            好友
          </div>
        </div>
      </Link>
      <div
        className="pt-4.5 pr-2 pb-1 pl-2.5 text-xs text-white flex justify-between items-center flex-shrink-0 w-full"
        style={{ maxWidth: "224px" }}
      >
        私信
